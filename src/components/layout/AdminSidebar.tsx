...
const menuSections: MenuSection[] = [
  {
    ...
    items: [
      ...
      { title: "Employees", translate: "nav.employees", icon: UserCog, path: "/employees", moduleId: "employees" },
      // {
      ...
      },
      {
        ...
        subItems: [
          ...
          { title: "HR AI", translate: "nav.fitrobitAI", path: "/fitrobit-ai", icon: Bot, moduleId: "dashboard" },
        ],
      },
    ],
  },
