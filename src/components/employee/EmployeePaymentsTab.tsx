...
const paymentData: Payment[] = [
  { id: 1, receiptNo: "REC-2024-001", date: "Jan 15, 2024", description: "Premium Employeeship - Annual", amount: "$599.00", method: "Credit Card", status: "paid" },
  ...
  { id: 4, receiptNo: "REC-2023-043", date: "Nov 15, 2023", description: "Premium Employeeship - Monthly", amount: "$59.00", method: "Credit Card", status: "paid" },
  { id: 5, receiptNo: "REC-2023-042", date: "Oct 15, 2023", description: "Premium Employeeship - Monthly", amount: "$59.00", method: "Bank Transfer", status: "paid" },
];

export function EmployeePaymentsTab({ id }: EmployeePaymentsTabProps) {
